...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  /* ── Envoltorio de referencia para el responsive ───────────────
     Define el "contenedor" de las container queries: los breakpoints
     de más abajo reaccionan al ancho de ESTE elemento (= ancho real
     del widget), no al de la ventana. Así el widget se adapta bien
     aunque cambies --width o lo incrustes en una columna estrecha. */
  .ftw-container {
    width: var(--width);
    max-width: 100%;
    margin: 0 auto;
  ...
  /* Variantes cortas de texto: solo visibles en móvil (ver container queries) */
  .ftw-titulo-corto { display: none; }
  .ftw-label-corto  { display: none; }

  /* ── Responsive (container queries) ──────────────────────────────
     Reaccionan al ancho del propio widget (.ftw-container), no al de
     la ventana. Ver el envoltorio .ftw-container definido arriba. */

  /* Tablet / móvil normal: reducir espaciados */
  @container ftw (max-width: 540px) {
  ...
  @container ftw (max-width: 420px) {
    #ftw-widget     { --radius: 16px; --radius-md: 11px; }
    ...
    /* Título compacto: solo "Asistente" */
    .ftw-titulo-full { display: none; }
    .ftw-titulo-corto { display: inline; }
    #ftw-soporte-fijo .ftw-label { display: none; }
    /* Botón de WhatsApp circular (igual que el de tema) */
    #ftw-soporte-fijo { width: 40px; height: 40px; padding: 0; gap: 0; justify-content: center; }
    #ftw-soporte-fijo .ftw-icon { margin-right: 0; width: 18px; height: 18px; }
    /* Botón de tema más grande */
    #ftw-btn-tema { width: 40px; height: 40px; }
    #ftw-btn-tema .ftw-icon { width: 19px; height: 19px; }
    ...
    /* Botón "Atrás" más grande y con texto */
    #ftw-btn-atras { padding: 10px 16px; font-size: .9rem; }
    #ftw-btn-atras .ftw-label-corto { display: inline; }
  ...
  @container ftw (max-width: 340px) {
    #ftw-widget     { --radius: 12px; --radius-md: 9px; }
...
<div id="ftw-widget">
  ...
  <div id="ftw-header">
    <span id="ftw-header-titulo">
      ...
      <span class="ftw-titulo-full">Asistente de instalación y configuración</span>
      <span class="ftw-titulo-corto">Asistente</span>
    </span>
    <button type="button" id="ftw-btn-tema" aria-label="Cambiar a modo claro"></button>
    <button type="button" id="ftw-soporte-fijo">
  ...
  <div id="ftw-footer">
    <button type="button" id="ftw-btn-atras">
      ...
      <span class="ftw-label-corto">Atrás</span>
    </button>
...
/* Inicialización */
document.getElementById("ftw-soporte-fijo").addEventListener("click", () => irANodo("soporte_directo", "Soporte"));
